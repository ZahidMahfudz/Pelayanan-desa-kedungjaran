<x-layout>
    ...
    <x-slot:tabs>Buat SKWN</x-slot>
        ...
        <form id="skForm" action="{{ route('edit_SKWN', ['id'=>$surat->id]) }}" method="POST">
            @csrf
            <fieldset>
            ...
            <fieldset>
                ...
                <div>
                    <div class="col-sm-10">
                        ...
                        <textarea name="keterangan" id="keterangan" cols="5" rows="5" class="form-control">{{ $skwn->keterangan }}</textarea>
                    </div>
                    <div class="col-sm-10">
                        <label for="keperluan" class="form-label">Tulis keperluan Pemohon</label>
                        <textarea name="keperluan" id="keperluan" cols="5" rows="5" class="form-control">{{ $skwn->keperluan }}</textarea>
                    </div>
                </div>
            </fieldset>
