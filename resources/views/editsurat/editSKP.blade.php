<x-layout>
    ...
    <x-slot:tabs>Edit SKP</x-slot>
        
        <form id="update_skp" action="{{ route('update_skp', ['id'=>$surat->id]) }}" method="POST">
            @csrf
            <fieldset>
            ...
            <fieldset>
                ...
                <div>
                    <div class="col-sm-10">
                        <label for="penghasilan" class="form-label">Tulis penghasilan Pemohon</label>
                        <input type="number" name="penghasilan" id="penghasilan" class="form-control" value="{{ $skp->penghasilan }}">
                    </div>
                    <div class="col-sm-10">
                        <label for="keperluan" class="form-label">Tulis keperluan Pemohon</label>
                        <textarea name="keperluan" id="keperluan" cols="5" rows="5" class="form-control">{{ $skp->keperluan }}</textarea>
                    </div>
                </div>
            </fieldset>
