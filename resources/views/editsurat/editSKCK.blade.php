<x-layout>
    ...
    <x-slot:tabs>Edit SKCK</x-slot>
        
        <form id="edit_SKCK" action="{{ route('edit_SKCK', ['id'=>$surat->id]) }}" method="POST">
            @csrf
            <fieldset>
            ...
            <fieldset>
                ...
                <div>
                    <div class="col-sm-10">
                        ...
                        <textarea name="keperluan" id="keperluan" cols="5" rows="5" class="form-control">{{ $skck->keperluan }}</textarea>
                    </div>
                </div>
            </fieldset>
