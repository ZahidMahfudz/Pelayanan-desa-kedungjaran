<x-layout>
    ...
    <x-slot:tabs>Buat SKTM</x-slot>
        ...
        <form id="skForm" action="{{ route('edit_sktm', ['id'=>$surat->id]) }}" method="POST">
            @csrf
            <fieldset>
            ...
            <fieldset>
                ...
                <div>
                    <div class="col-sm-10">
                        ...
                        <textarea name="keterangan" id="keterangan" cols="5" rows="5" class="form-control">{{ $sktm->keterangan }}</textarea>
                    </div>
                    <div class="col-sm-10">
                        <label for="keperluan" class="form-label">Tulis keperluan Pemohon</label>
                        <textarea name="keperluan" id="keperluan" cols="5" rows="5" class="form-control">{{ $sktm->keperluan }}</textarea>
                    </div>
                </div>
            </fieldset>
